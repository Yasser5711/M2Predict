...
def target_encode_oof(
    ...
    """
    OOF target encoding for train (leakage-safe),
    and mapping fitted on full train for test/inference.
    """
...
def main() -> None:
    pbar = tqdm(total=7, desc="train_hgb", unit="step")
    ...
    # on drop code_postal brut (sinon double info)
